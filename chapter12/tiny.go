/* Note: This code does not cover the Pascal or C style and semicolon and
comment parsing in this chapter. The code here matches the style described
for TINY 1.2:
...
C-Style comments are covered in chapter12b, but the pascal style is not
present
*/
...
var a,b,c;
begin
a=1*(b+4) {pascal comment here}
b=b+3 {comment with {nested } comment }
end.
*/
...
func IsWhite(r rune) bool {
	// SPACE / TAB / CR / LF / {
	return r == 0x20 || r == 0x09 || r == 0x0D || r == 0x0A || r == '{'
}
